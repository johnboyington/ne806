...
Find the coefficients $C_1$ and $Q_1$.

\begin{empheq}{align*}

    \frac{\frac{S_0}{D}\cos(\alpha T)}{\alpha^2+B^2} - \frac{S_0e^{BT}}{4D(\alpha^2+B^2)[1-2DB]} +C_2\bigg[e^{-BT}-e^{BT}\frac{[1+2DB]}{[1-2DB]}\bigg] &=  \frac{-\frac{S_0}{D}}{\Sigma_a^2-B^2} + \frac{\frac{S_0}{D}e^{\Sigma_a T}(1+2D\Sigma_a)e^{BT}}{(\Sigma_a^2-B^2)(e^{2TB})[1+2DB]} \\ &+Q_2\bigg[e^{-BT}-e^{BT}\frac{(e^{-2BT})[1-2DB]}{(e^{2BT})[1+2DB]}\bigg] \\

    -\frac{\alpha\frac{S_0}{D}\sin(\alpha T)}{\alpha^2+B^2} - \frac{S_0Be^{BT}}{4D(\alpha^2+B^2)[1-2DB]} -C_2\bigg[Be^{-BT}+Be^{BT}\frac{[1+2DB]}{[1-2DB]}\bigg] &= -\frac{\Sigma_a\frac{S_0}{D}}{\Sigma_a^2-B^2} + \frac{\frac{S_0}{D}Be^{\Sigma_a T}(1+2D\Sigma_a)e^{BT}}{(\Sigma_a^2-B^2)(e^{2TB})[1+2DB]} \\ &-Q_2\bigg[Be^{-BT}+Be^{BT}\frac{(e^{-2BT})[1-2DB]}{(e^{2BT})[1+2DB]}\bigg]
...
\begin{empheq}{align*}
    ...
    C_2 &= \frac{Q_2\bigg[e^{-BT}-e^{BT}\frac{(e^{-2BT})[1-2DB]}{(e^{2BT})[1+2DB]}\bigg] + \frac{-\frac{S_0}{D}}{\Sigma_a^2-B^2} + \frac{\frac{S_0}{D}e^{\Sigma_a T}(1+2D\Sigma_a)e^{BT}}{(\Sigma_a^2-B^2)(e^{2TB})[1+2DB]} + \frac{S_0e^{BT}}{4D(\alpha^2+B^2)[1-2DB]} - \frac{\frac{S_0}{D}\cos(\alpha T)}{\alpha^2+B^2}}{\bigg[e^{-BT}-e^{BT}\frac{[1+2DB]}{[1-2DB]}\bigg]}\\

    Q_2 &= \frac{C_2\bigg[Be^{-BT}+Be^{BT}\frac{[1+2DB]}{[1-2DB]}\bigg]-\frac{\Sigma_a\frac{S_0}{D}}{\Sigma_a^2-B^2} + \frac{\frac{S_0}{D}Be^{\Sigma_a T}(1+2D\Sigma_a)e^{BT}}{(\Sigma_a^2-B^2)(e^{2TB})[1+2DB]} + \frac{\alpha\frac{S_0}{D}\sin(\alpha T)}{\alpha^2+B^2} + \frac{S_0Be^{BT}}{4D(\alpha^2+B^2)[1-2DB]}}{\bigg[Be^{-BT}+Be^{BT}\frac{(e^{-2BT})[1-2DB]}{(e^{2BT})[1+2DB]}\bigg]}

\end{empheq}

$Q_2$ is substituted into $C_2$ and then back inserted into previous equations to obtain coefficients for each slab's equation.
